...
def monte(env, num_episodes=500000, gamma=0.999, epsilon_start=1,epsilon_end=0.01,decay_factor=0.95):
...
torch.save(Q_tensor, '/home/RL/ass3/saved_policy/mc_taxi_q_table.pt')


#plot_rewards_vs_episodes(rewards_per_episode, '/home/RL/ass2/plots/p2.2/Taxi_qlearn_reward_vs_episode.png')
plot_avg_rewards_vs_episodes(rewards_per_episode, '/home/RL/ass3/plots/p1/Avg_Taxi_mc_reward_vs_episode.png')
visualize_policy_execution_taxiv3(env, Q, gif_path='/home/RL/ass3/plots/p1/Taxi_mc_policy_execution.gif')
epsilon_vs_episodes(epsilon_per_episode,'/home/RL/ass3/plots/p1/Taxi_mc_epsilon_vs_episode.png')
