...
import numpy as np
import random
from plots import plot_rewards_vs_episodes  ,visualize_policy_execution_taxiv3, epsilon_vs_episodes,plot_avg_rewards_vs_episodes
import torch
from eval import evaluate_policy_taxi
import time

def qlearn(env, num_episodes=50000, alpha=0.05, gamma=0.95, epsilon_start=1,epsilon_end=0.001,decay_factor=0.99):
...
torch.save(Q_tensor, '/home/RL/ass2/saved_policy/qlearn_taxi_q_table.pt')


#plot_rewards_vs_episodes(rewards_per_episode, '/home/RL/ass2/plots/p2.2/Taxi_qlearn_reward_vs_episode.png')
plot_avg_rewards_vs_episodes(rewards_per_episode, '/home/RL/ass2/plots/p2.2/Avg_Taxi_qlearn_reward_vs_episode.png')
visualize_policy_execution_taxiv3(env, Q, gif_path='/home/RL/ass2/plots/p2.2/Taxi_qlearn_policy_execution.gif')
epsilon_vs_episodes(epsilon_per_episode,'/home/RL/ass2/plots/p2.2/Taxi_qlearn_epsilon_vs_episode.png')

evaluate_policy_taxi(env,'/home/RL/ass2/saved_policy/qlearn_taxi_q_table.pt','/home/RL/ass2/videos/Taxi_qlearn_episode_')
env.close()